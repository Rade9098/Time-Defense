...
public class GlobalDataScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        questList.Add(new Quest("Quest 2", 1, true, "Upgrade a weapon to level 3.", new string[1] { "Upgrade any weapon stat to level 3." }));
        ...
        questList.Add(new Quest("Quest 4", 1, true, "Defeat a siege monster.", new string[1] { "Defeat a siege monster." }));
        questList.Add(new Quest("Quest 5", 1, true, "Kill 500 enemies.", new string[1] { "Kill 500 enemies" }));
        questList.Add(new Quest("Quest 6", 1, true, "Collect 100,000 gold.", new string[1] { "Get 100,000 gold" }));
